...
export function ProductCategoryDialog({
  ...
  const createCategory = useMutation(api.productCategories.mutations.createCategory);
  const updateCategory = useMutation(api.productCategories.mutations.updateCategory);
